...
train_sizes, training_scores, test_scores = learning_curve(AdaBoostClassifier(n_estimators = 1,learning_rate=0.2,algorithm='SAMME' ),
                                                   X,
...
train_sizes, train_scores, test_scores = learning_curve(AdaBoostClassifier(n_estimators = 1,learning_rate=0.2,algorithm='SAMME' ),
                                                   X,
                                                   y, train_sizes = train_sizes, cv = 5,
