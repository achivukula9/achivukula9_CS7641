...
train_sizes, training_scores, test_scores = learning_curve(KNeighborsClassifier(n_neighbors = 5, metric = 'minkowski', p = 2,algorithm='auto'),
                                                   X,
...
train_sizes, train_scores, test_scores = learning_curve(KNeighborsClassifier(n_neighbors = 3, metric = 'minkowski', p = 2,algorithm='ball_tree' ),
                                                   X,
                                                   y, train_sizes = train_sizes, cv = 5,
